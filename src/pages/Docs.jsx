    ...
    tools: [
      {
        ...
        name: 'AI Writer',
        color: '#a78bfa',
        tagline: 'Write anything — 19 content types, humanize, A/B test, analyze tone',
        what: 'AI Writer generates professional content for any purpose. Choose from 19 content types like blog posts, LinkedIn posts, cold emails, YouTube scripts, and more. It also lets you Humanize AI text, create A/B variants, and analyze tone.',
        tabs: [
        ...
        fields: [
          { name: 'Content Type', desc: 'Pick what you want to create — 19 options from Blog post to Video script' },
        ...
        tips: [
          ...
          'If you saved a business context from Business Strategist, a banner offers to reuse it here automatically instead of retyping your topic',
        ],
      },
      {
        id: 'codehelper',
        ...
        name: 'Code Helper',
        color: '#60a5fa',
        tagline: 'Fix bugs, explain code, generate git commits, run security audits — and actually run JavaScript live in your browser',
        what: 'Code Helper is your AI pair programmer. It fixes bugs, explains code, writes from scratch, converts between languages, and has unique features: a visual logic flowchart, a Live Sandbox that actually runs your JavaScript code with automatic AI-driven error fixing, Git Commit Generator (3 versions), and Security Audit (vulnerability scanner with score).',
        tabs: [
...
const password = "admin123";`,
        ...
        tips: [
          ...
          'For JavaScript: click \'Run It Live\' to actually execute the code in a safe browser sandbox — if it errors, click Auto-Fix and AI will try up to 3 different strategies to fix it automatically',
        ],
      },
      {
        id: 'creator',
...
Master Blueprint: Month 1: 50 beta users. Month 2: ProductHunt launch, 500 users. Month 3: B2B HR tie-ups.`,
      ...
      },
      {
        ...
        color: '#f97316',
        tagline: '6 AI experts walk through your business idea — market, revenue, competition, risk, growth, and finances',
        what: 'Business Strategist is a structured brainstorming tool. Describe a business idea and 6 AI personas analyze it one after another — Market Validator, Revenue Architect, Competitor Assassin, Risk Auditor, GTM Strategist, and Financial Modeler — ending with an Executive Summary. Treat the output as a well-organized starting point for your own research, not as verified market data.',
        fields: [
          { name: 'Business Idea', desc: 'Describe your idea — what it does, who it is for, and how you plan to make money. The more detail you give, the more specific the analysis.' },
          { name: 'Business Stage', desc: 'Idea stage, early traction, or scaling — helps tailor the depth of the analysis' },
        ],
        agents: [
          { name: '📊 Market Validator', desc: 'Market size estimate, target customer, demand signals, timing, go/no-go verdict' },
          { name: '💰 Revenue Architect', desc: 'Pricing model, price points, revenue streams, unit economics reasoning' },
          { name: '⚔️ Competitor Assassin', desc: 'Likely competitors, their weaknesses, your possible edge, differentiation' },
          { name: '🛡️ Risk Auditor', desc: 'Top failure modes, market/execution/financial risks, mitigation per risk' },
          { name: '🚀 GTM Strategist', desc: 'Launch channels, first-customer playbook, 90-day plan, budget split' },
          { name: '📈 Financial Modeler', desc: 'Startup costs, operating costs, revenue build-up, break-even reasoning' },
        ],
        steps: [
          'Describe your business idea in the text area',
          'Select your business stage (idea / early traction / scaling)',
          'Click "Analyze My Business"',
          'Watch each of the 6 experts respond one after another',
          'Read each expert\'s section — they build on what came before',
          'Read the Executive Summary at the end',
          'Copy or save the report as a starting point for deeper research',
        ],
        examples: [
          {
            label: 'Subscription App Idea',
            input: 'Business idea: A subscription meal-planning app for busy families in India, ₹199/month, focused on regional recipes and grocery list generation.\nStage: Idea stage',
            output: 'Market Validator gives a category-size estimate and target customer profile. Revenue Architect suggests a freemium-to-paid structure. Competitor Assassin discusses the indirect competition (grocery and recipe apps) without inventing fake named competitors. Risk Auditor flags retention as the top risk. GTM Strategist suggests regional-language content channels. Financial Modeler outlines rough early costs and a break-even reasoning path. Executive Summary ties it together.',
          },
        ],
        tips: [
          'Be specific — include your target audience, rough pricing idea, and what makes your version different',
          'Treat numbers and competitor names as estimates and starting points, not verified facts — always double-check anything important with real research before acting on it',
          'Do not refresh the page while the 6 experts are running — it will stop the analysis',
          'Use the Executive Summary as a brainstorming map, then go validate the biggest assumptions yourself',
          'After the Executive Summary, an Idea Scorecard (radar chart), a Competitive Position Map, and a Live Revenue Calculator appear — drag the calculator slider to see profit and break-even change in real time as you adjust user count',
        ],
      },
      {
        id: 'seo',
        ...
        name: 'SEO Optimizer',
        color: '#22c55e',
        tagline: '7 SEO tools in one: Keyword Lab, SERP Simulator, Content Scorer, Topic Clusters, Content Gap, Meta Forge, Schema Generator',
        ...
        tabs: [
          ...
          { name: 'Content Scorer', desc: 'Score and fix your existing content for SEO' },
...
Question: "What are the payment terms and penalty clauses in this contract?"`,
      ...
      },
      {
        ...
        name: 'Data Wizard',
        color: '#06b6d4',
        tagline: 'Generate SQL, Excel, Python, Regex, DAX, R, Shell, GraphQL, and data viz code — 9 formats in one tool',
        what: 'Data Wizard is an expert formula and query generator. Describe what you need in plain English and it writes the code. Supports 9 formats: SQL (PostgreSQL/MySQL/BigQuery), Excel/Google Sheets, Python (Pandas/NumPy), Regex, Data Visualization (Matplotlib/Plotly), DAX (Power BI), R Script (dplyr/ggplot2), Shell/AWK/Sed pipelines, and JSON/GraphQL queries. It can also explain and audit existing formulas you already have.',
        tabs: [
          { name: 'SQL Query', desc: 'PostgreSQL, MySQL, BigQuery, Snowflake' },
          { name: 'Excel / Google Sheets', desc: 'XLOOKUP, SUMIFS, array formulas, pivot' },
          { name: 'Python (Pandas/NumPy)', desc: 'Data manipulation, analysis, cleaning' },
          { name: 'Regular Expression', desc: 'Pattern matching, validation, extraction' },
          { name: 'Data Visualization (Matplotlib/Plotly)', desc: 'Charts, dashboards, interactive visualizations' },
          { name: 'DAX / Power BI', desc: 'Measures, KPIs, time intelligence' },
          { name: 'R Script (dplyr/ggplot2)', desc: 'Statistical analysis, ggplot visualizations' },
          { name: 'Shell / AWK / Sed Pipeline', desc: 'Unix pipelines, log processing, ETL' },
          { name: 'JSON / GraphQL Query', desc: 'API queries, transformations, schema' },
        ],
        fields: [
          { name: 'Formula Type', desc: 'Select from 9 types: SQL, Excel, Python, Regex, Data Viz, DAX, R, Shell, or JSON/GraphQL' },
...
Need: Extract all email addresses from a block of text`,
        ...
        tips: [
          ...
          'For SQL, Excel, and Python formulas: a Live Result panel often appears below the formula, showing it actually computing on AI-generated sample data — this proves the formula works rather than just describing it',
          'Use Explain Existing mode to paste a formula or query you already have and get a line-by-line breakdown plus an improved version',
        ],
      },
      {
        id: 'spider',
